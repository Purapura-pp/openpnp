...
* German, Spanish, French, Italian and Russian are now complete translations. They were not: German had 112 of the interface's strings, Italian 73, French 76 and Spanish 66, out of 2696, so choosing one of those languages changed a handful of menu items and left the rest of the program in English. Russian was further along at 1683 but still missing a third. All five now cover every translatable string, and all five have the Issues and Solutions descriptions, which previously existed only in Simplified Chinese.
